...
export default function Contact() {
  ...
  return (
    <section ref={sectionRef} className="py-12 lg:py-[80px] bg-white relative">
      <Container>
        ...
        <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-7 reveal-card">
                <div className="flex flex-wrap justify-between gap-8 text-sm font-medium text-body pb-5">
                    ...
                    <div className="flex items-center gap-2">
                        <Image src="/headphone.svg" alt="Headphone" width={20} height={20} />
                        24/7 Support
                    </div>
                </div>
                <div className="space-y-6 p-6 rounded-lg border border-[#D8DEE2]">
                   <h3 className="text-lg font-semibold text-display">Send us a message.</h3>
                   
                   <form className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-sm lg:text-base font-medium text-[#040813] opacity-[0.8] inline-block mb-2">Name *</label>
                            <input 
                                type="text" 
                        ...
                        <div className="space-y-2">
                            <label className="text-sm lg:text-base font-medium text-[#040813] opacity-[0.8] inline-block mb-2">Email *</label>
                            <input 
                                type="email" 
                        ...
                        <div className="space-y-2">
                            <label className="text-sm lg:text-base font-medium text-[#040813] opacity-[0.8] inline-block mb-2">Company</label>
                            <input 
                                type="text" 
                        ...
                        <div className="space-y-2">
                            <label className="text-sm lg:text-base font-medium text-[#040813] opacity-[0.8] inline-block mb-2">Company Stage</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-sm lg:text-base font-medium text-[#040813] opacity-[0.8] inline-block mb-2">Message *</label>
                            <textarea 
                                rows="5"
                ...
                <div className="bg-white rounded-2xl border border-[#D8DEE2] p-8 h-full flex flex-col">
                    <ul className="space-y-6 mb-8">
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="lg:text-lg text-body">Antwerp, Belgium</h4>
                            </div>
                        </li>
                        <li className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-lg border border-[#E7E9EF] bg-[#F9FAFB] flex items-center justify-center text-display shrink-0">
                            ...
                            <div>
                                <h4 className="lg:text-lg text-body">Hello@Normora.Com</h4>
                            </div>
                        </li>
                        <li className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-lg border border-[#E7E9EF] bg-[#F9FAFB] flex items-center justify-center text-display shrink-0">
                            ...
                            <div>
                                <h4 className="lg:text-lg text-body">+32 4XX XXX XXX</h4>
                            </div>
                        </li>
                    </ul>

                    <div className="flex gap-4 mb-8">
                         <a href="#" className="w-10 h-10 rounded-lg border border-gray-200 flex items-center justify-center text-body hover:bg-primary hover:text-white hover:border-primary transition-colors">
